...
# Qontextual
株式会社エクサウィザーズのFAQ検索エンジン Qontextual を使っています。  
汎用言語モデルを使用したAIを活用して、”意味の近しい言葉や文” を検索できます。  
気になるキーワードや、文章を検索してください。  
例えば「マスク」「消毒液」「施設でのレクリエーション」といった言葉で調べることができます。

* [ナレッジ画面](https://khma-covid19.qontextual.jp/user/dirfaq)
* [チャット画面](https://khma-covid19.qontextual.jp/chat.html#khma-covid19-qa)
...
菅野晶仁、曽根尚史、松崎綾乃、猪股光
          ...
          <div id="qon-chatwidget-div" />
          <script type="text/javascript" src="https://khma-covid19.qontextual.jp/chatwidget/qon-chatwidget-loader.js" />
          <script>
